        ...
        <div class="container">
          <div class="hero-slide-content">
            ...
            <div style="display: flex; gap: 1rem; margin-top: 2rem;">
              ...
              <a href="<?php echo esc_url( home_url( '/rates' ) ); ?>" class="btn-primary" style="background: transparent; border-color: #ffffff; color: #ffffff;">Gallery and Event Bookings</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="hero-slide">
        ...
        <div class="container">
          <div class="hero-slide-content">
            ...
            <a href="<?php echo esc_url( home_url( '/rates' ) ); ?>" class="btn-primary">Gallery and Event Bookings</a>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 2.5rem;">
          <div style="border-left: 2px solid var(--primary-color); padding-left: 1rem;">
            ...
            <p style="font-weight: 700; color: var(--primary-color); font-size: 1.1rem; margin-top: 0.25rem;">Inquire for Availability</p>
          </div>
          <div style="border-left: 2px solid var(--primary-color); padding-left: 1rem;">
